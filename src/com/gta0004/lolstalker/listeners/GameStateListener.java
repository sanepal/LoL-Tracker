...
public class GameStateListener extends AbstractPlayerActivityListener {
	...
	public GameStateListener(SummonerDto summoner) {
		...
		try {
		  ...
		  // probably have some re-try logic or fallback logic or kill the application here
		}
	}
	...
	public void run() {
		try {
			...
			Log.i("GameStateListener", "Last Match ID: " + lastMatchId + " Most Recent Match ID: " + mostRecentMatchId);
